              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-border/50 bg-card/30 p-8 backdrop-blur-sm transition-all duration-500 hover:border-primary/30 hover:bg-card/50">
                  ...
                  <div className="relative z-10">
                    <div className="mb-6 inline-flex rounded-xl border border-primary/20 bg-primary/10 p-4 transition-all duration-500 group-hover:rotate-3 group-hover:scale-110 group-hover:border-primary/40 group-hover:shadow-[0_0_30px_hsl(var(--primary)/0.25)]">
