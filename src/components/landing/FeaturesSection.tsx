  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <div className="mb-5 inline-flex rounded-lg border border-primary/20 bg-primary/10 p-3 transition-all duration-300 group-hover:border-primary/40 group-hover:bg-primary/15 group-hover:shadow-[0_0_20px_color-mix(in_oklch,var(--primary)_35%,transparent)]">
