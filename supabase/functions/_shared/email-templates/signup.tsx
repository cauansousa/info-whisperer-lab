    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          ...
          Para começar, confirme o endereço <strong>{recipient}</strong> clicando no botão abaixo.
        </Text>
        <Section style={btnWrap}>
          <Button style={button} href={confirmationUrl}>Confirmar e-mail</Button>
        </Section>
        <Text style={smallText}>Se você não criou essa conta, pode ignorar este e-mail com segurança.</Text>
